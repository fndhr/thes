    ...
    <div class="row justify-content-center">
        <div class="col-11">
            ...
            <div class="row py-2 mb-2">
                ...
                <div class="col-1">@if(!($consult < $student->session->minimum_consultation))&#10003;@endif</div>
            </div>
            @php($sts_title = NULL)
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="display: flex; justify-content: space-around;">
                                    <form id="button-yes-title{{$title->title_id}}" class="submitForm" action="/admin/approve/title" method="POST">@csrf<input for="title" name="title" value="{{$title->title_id}}" style="display:none"><input for="std" name="std" value="{{$student->std_id}}" style="display:none">
                                        <button type="submit" class="btn btn-outline-success btn-sm btn-pill btnSubmit py-2 px-3">YES</button>
                                    </form>
                                    <form id="button-no-title{{$title->title_id}}" class="submitForm" action="/admin/disapprove/title" method="POST">@csrf<input for="title" name="title" value="{{$title->title_id}}" style="display:none"><input for="std" name="std" value="{{$student->std_id}}" style="display:none">
                        ...
                        <tbody>
                            ...
                            @foreach($student->proposedAdvisor as $advisor)
                                ...
                                <tr>
                                    ...
                                    <td style="display: flex; justify-content: space-around;">
                                        <form id="button-yes-advisor{{$advisor->advisor_id}}" class="submitForm" action="/admin/approve/advisor" method="POST">@csrf<input for="advisor" name="advisor" value="{{$advisor->advisor_id}}" style="display:none"><input for="std" name="std" value="{{$student->std_id}}" style="display:none">
                                            <button type="submit" class="btn btn-outline-success btn-sm btn-pill btnSubmit py-2 px-3">YES</button>
                                        </form>
                                        <form id="button-no-advisor{{$advisor->advisor_id}}" class="submitForm" action="/admin/disapprove/advisor" method="POST">@csrf<input for="advisor" name="advisor" value="{{$advisor->advisor_id}}" style="display:none"><input for="std" name="std" value="{{$student->std_id}}" style="display:none">
                                            <button type="submit" class="btn btn-outline-danger btn-sm btn-pill btnSubmit py-2 px-3">NO</button>
                                        </form>
                                    </td>
                                </tr>
            ...
            <div class="row py-2 mb-2">
                ...
                <form id="viewFileProposal" action="/viewFileProposal" method="POST" style="display: none;">@csrf<input for="ThesisProposal" name="ThesisProposal" value="{{$student->documentUpload[0]->doc_name}}" style="display:none"><input for="studentId" name="studentId" value="{{$student->std_id}}"style="display:none" target="_blank"></form>
                <div class="col-1">&#10003;</div>
            </div>
            @endif
            ...
            <div class="row py-2 mb-2">
                ...
                <form id="viewFileInterim" action="/viewFileInterim" method="POST" style="display: none;">@csrf<input for="ThesisInterim" name="ThesisInterim" value="{{$student->documentUpload[1]->doc_name}}" style="display:none"><input for="studentId" name="studentId" value="{{$student->std_id}}"style="display:none" target="_blank"></form>
                <div class="col-1">&#10003;</div>
            </div>
            @endif
            @if(count($student->documentUpload)>=3 && $student->documentUpload[2]->status==2)
                <div class="row py-2 mb-2">
                    ...
                    <form id="viewFileFinalDraft" action="/viewFileFinalDraft" method="POST" style="display: none;">@csrf<input for="FinalDraft" name="FinalDraft" value="{{$student->documentUpload[2]->doc_name}}" style="display:none"><input for="studentId" name="studentId" value="{{$student->std_id}}"style="display:none" target="_blank"></form>
                    <div class="col-1">&#10003;</div>
                </div>
            ...
            @if(count($student->documentUpload)>=4  && $student->documentUpload[3]->status==2)
                <div class="row py-2 mb-2">
                    ...
                    <form id="viewFileRevisedDoc" action="/viewFileRevisedDoc" method="POST" style="display: none;">@csrf<input for="signedRevisedDoc" name="signedRevisedDoc" value="{{$student->documentUpload[3]->doc_name}}" style="display:none"><input for="studentId" name="studentId" value="{{$student->std_id}}"style="display:none" target="_blank"></form>
                    <div class="col-1">&#10003;</div>
                </div>
            @endif
            @if(count($student->documentUpload)>=5 && $student->documentUpload[4]->status==2)
                <div class="row py-2 mb-2">
                    ...
                    <form id="viewFileFinalizedDoc" action="/viewFileFinalizedDoc" method="POST" style="display: none;">@csrf<input for="finalizedDoc" name="finalizedDoc" value="{{$student->documentUpload[4]->doc_name}}" style="display:none"><input for="studentId" name="studentId" value="{{$student->std_id}}"style="display:none"  target="_blank"></form>
                    <div class="col-1">&#10003;</div>
                </div>
            @endif
            <div class="row py-2 mb-2">
