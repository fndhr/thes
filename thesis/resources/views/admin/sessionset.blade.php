        ...
        <div class="col-11">
            <form method="POST" action="/admin/createSessionSet" class="submitForm">
                ...
                <div class="form-group row">
                    ...
                    <input type="text" id="datepicker1" class="form-control col-7 @error('end_date_title_advisor') is-invalid @enderror" name="end_date_title_advisor" placeholder="ex:01/01/2020" value="{{old('end_date_title_advisor')}}">
                ...
                <div class="form-group row">
                    <label class="col-3 col-form-label inputRequired">Deadline*</label>
                    <input type="text" id="datepicker2" class="form-control col-7 @error('end_date_signed_thesis') is-invalid @enderror" name="end_date_signed_thesis" placeholder="ex:01/01/2020" value="{{old('end_date_signed_thesis')}}">
                ...
                <div class="form-group row">
                    <label class="col-3 col-form-label inputRequired">Deadline*</label>
                    <input type="text" id="datepicker3" class="form-control col-7 @error('end_date_interim') is-invalid @enderror" name="end_date_interim" placeholder="ex:01/01/2020" value="{{old('end_date_interim')}}">
                ...
                <div class="form-group row">
                    <label class="col-3 col-form-label inputRequired">Deadline*</label>
                    <input type="text" id="datepicker4" class="form-control col-7 @error('end_date_final_draft') is-invalid @enderror" name="end_date_final_draft" placeholder="ex:01/01/2020" value="{{old('end_date_final_draft')}}">
